...
export const ventures: Venture[] = [
  {
    ...
    story: 'Sanchaya addresses the critical issues of fraud and lack of trust in India\'s informal chit fund industry. By leveraging voice-based technology and blockchain, it provides a secure and transparent platform for millions of families.',
    role: 'Founder & Architect',
    details: [
      'Problem: Millions of families risk losing their savings in a $50 billion informal chit fund market plagued by fraud.',
      'Solution: A first-of-its-kind platform using voice biometrics and blockchain to create a fraud-proof, accessible financial ledger.',
      'Impact: Empowers financial inclusion by transforming a high-risk system into a secure and transparent ecosystem for the underserved.',
    ],
  ...
  },
  {
    ...
    story: "Revive was born from the challenge of providing timely and effective healthcare in rural areas. It’s an offline-first platform that uses AI to assist healthcare workers and enable faster emergency response.",
    role: 'Co-founder & Systems Architect',
    details: [
      'Problem: Limited access to doctors in rural areas leads to delayed care and overburdened healthcare workers.',
      'Solution: An offline-first AI platform that assists local health workers with preliminary diagnostics, reducing doctor workload by 40%.',
      'Impact: Delivers 24/7 emergency support and brings reliable, scalable healthcare to remote communities where it is needed most.',
    ],
  ...
  },
  {
    ...
    story: 'NeuroDam provides a critical decision-support system for managing dam operations and predicting floods. By analyzing vast datasets, it offers actionable intelligence to mitigate disaster risks.',
    role: 'Project Lead & AI Engineer',
    details: [
      'Problem: Dam operators lack predictive tools, leading to reactive decisions that risk lives and critical infrastructure during floods.',
      'Solution: An AI system that analyzes complex hydrological and meteorological data to provide real-time, predictive insights for dam management.',
      'Impact: Enables proactive flood control and enhances climate resilience for large-scale public infrastructure, protecting communities at risk.',
    ],
